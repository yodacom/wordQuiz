...
export const TypeReport = {
    1:'Your Type is 1 - The Reformer (the principled, idealistic type) ' +
    ...
    2:'Your Type is 2 - The Helper (the caring, interpersonal type) Twos are empathetic, sincere, ' +
    ...
    3:'Your Type is 3 - The Achiever (the adaptable, success-oriented type) Threes are self-assured, ' +
    ...
    'competitiveness. At their Best: self-accepting, authentic, everything they seem to berole models who ' +
    'inspire others.',

    4:'Your Type is 4 - The Individualist (the introspective, romantic type) Fours are self aware, sensitive, ' +
    ...
    5:'Your Type is 5 - The Investigator (the perceptive, cerebral type) Fives are alert, insightful, ' +
    ...
    6:'Your Type is 6 - The Loyalist (the committed, security-oriented type) Sixes are reliable, hard working, ' +
    'responsible, and trustworthy  Excellent troubleshooters, they foresee problems and foster cooperati' +
    ...
    7:'Your Type is 7 - The Enthusiast (the busy, productive type) Sevens are extroverted, optimistic, ' +
    ...
    8:'Your Type is 8 - The Challenger (the powerful, aggressive type) Eights are self-confident, strong ' +
    'and assertive. Protective, resourceful, straight-taling, and decisive, but can also be ego  centric ' +
    ...
    9:'Your Type is 9 - The Peacemaker (the easy  going, self  effacing type)Nines are accepting, ' +
